@extends('layout')
	...
	<div class="agilemodel-slider">
		<div id='film_roll_1'>
			<div><img src="{!! asset('images/model_slide-1.jpg') !!}" alt="Groovy Apparel"></div>
			<div><img src="{!! asset('images/model_slide-2.jpg') !!}" alt="Groovy Apparel"></div>
			<div><img src="{!! asset('images/model_slide-3.jpg') !!}" alt="Groovy Apparel"></div>
			<div><img src="{!! asset('images/model_slide-4.jpg') !!}" alt="Groovy Apparel"></div>
			<div><img src="{!! asset('images/model_slide-5.jpg') !!}" alt="Groovy Apparel"></div>
			<div><img src="{!! asset('images/model_slide-6.jpg') !!}" alt="Groovy Apparel"></div>
			<div><img src="{!! asset('images/model_slide-7.jpg') !!}" alt="Groovy Apparel"></div>
			<div><img src="{!! asset('images/model_slide-8.jpg') !!}" alt="Groovy Apparel"></div>
			<div><img src="{!! asset('images/model_slide-9.jpg') !!}" alt="Groovy Apparel"></div>
			<div><img src="{!! asset('images/model_slide-10.jpg') !!}" alt="Groovy Apparel"></div>
		</div>
	</div>
	<!-- //Model-Slider -->
		...
		<div class="container">
			...
			<div class="wthreehome-latest-grids">
				<div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid1">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{!! asset('images/home-latest-1.jpg') !!}" alt="Groovy Apparel">
				...
				<div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid2">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{!! asset('images/home-latest-2.jpg') !!}" alt="Groovy Apparel">
							<figcaption></figcaption>
						</figure>
					</div>
				...
				<div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid3">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{!! asset('images/home-latest-3.jpg') !!}" alt="Groovy Apparel">
							<figcaption></figcaption>
						</figure>
					</div>
					<h4>WATCHES</h4>
				...
				<div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid4">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{!! asset('images/home-latest-4.jpg') !!}" alt="Groovy Apparel">
							<figcaption></figcaption>
						</figure>
					</div>
					<h4>BEACH WEAR</h4>
	...
	<div class="wthreedenim-coll">
		<div class="style-grids">
			<div class="col-md-6 style-grid style-grid-1">
				<img src="{!! asset('images/style-1.jpg') !!}" alt="Groovy Apparel">
			...
			<div class="col-md-6 style-grid style-grid-2">
				<div class="style-image-1">
					<img src="{!! asset('images/style-2.jpg') !!}" alt="Groovy Apparel">
				...
				<div class="style-image-2">
					<img src="{!! asset('images/style-3.jpg') !!}" alt="Groovy Apparel">
					<div class="style-grid-2-text">
		...
		<div class="container">
			...
			<div class="agileshoppinggrids">
				<div class="col-md-6 agileshoppinggrid agileshoppinggrid1">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{!! asset('images/mens.jpg') !!}" alt="Groovy Apparel">
							<figcaption></figcaption>
						</figure>
					</div>
				</div>
				<div class="col-md-6 agileshoppinggrid agileshoppinggrid2">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{!! asset('images/womens.jpg') !!}" alt="Groovy Apparel">
							<figcaption></figcaption>
						</figure>
					</div>
				</div>
